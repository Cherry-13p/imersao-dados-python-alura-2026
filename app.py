...
# Filtragem do DataFrame (com base nas seleções feitas na barra lateral)
df_filtrado = df[
...
with col_graf1:
    if not df_filtrado.empty:
        ...
        grafico_cargos = px.bar(
            ...
            labels={"usd": "Média salarial anual (USD)", "cargos": ''}
        )
...
with col_graf4:
    if not df_filtrado.empty:
        ...
        grafico_paises.update_layout(title_x=0.3)
